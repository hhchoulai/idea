...
public class Constant {
    ...
    //课程信息插入的宽高标题
    public static final int TEACHER_COURSEINSERT_WIDTH=500;
    public static final int TEACHER_COURSEINSERT_HEIGHT=350;
    public static final String TEACHER_COURSEINSERT_TITLE="课程信息插入";
    //成绩插入
